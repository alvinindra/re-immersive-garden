// Ported verbatim from the real site (default bundle shader s034).
// Classic OGL-style ping-pong flowmap: each frame the previous flow is read,
// dissipated, then a velocity "stamp" is added at the (eased) mouse position.
// Output channels: rg = velocity, b = velocity magnitude, a = presence.
