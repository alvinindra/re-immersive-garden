// Ported verbatim from the real site (default bundle shader s033).
// three.js ShaderMaterial injects: position, normal, uv attributes and
// modelMatrix / modelViewMatrix / projectionMatrix / viewMatrix /
// normalMatrix / cameraPosition uniforms — so they are not redeclared here.
#include ./config.glsl
